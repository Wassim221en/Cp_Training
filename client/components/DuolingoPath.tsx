...
const getNodePosition = (index: number) => {
  const patterns = [
    50, 20, 80, 35, 65, 25, 75, 40, 60, 30, 70, 45, 55, 35, 65, 25, 75, 50,
  ];
        ...
        return (
          ...
          >
            ...
            >
              ...
              {nodeState === "unlocked" && (
                <div
                  className={`absolute inset-0 rounded-3xl bg-gradient-to-r ${colors.gradient} opacity-25 blur-xl scale-110 pointer-events-none`}
                />
              )}
